...
→ claude-pm:pm-review → Task PRs reviewed, merged into feature branch, lessons learned
...
| `claude-pm:pm-review` | Poll task PRs for reviews, merge into feature branch, capture lessons learned |
